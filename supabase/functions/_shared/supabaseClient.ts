...
// For maitalent.fun promo redemption, we need to connect to TrollCity DB
...
const supabaseUrl = Deno.env.get("TROLLCITY_DB_URL") || Deno.env.get("SUPABASE_URL")!;
const supabaseServiceKey = Deno.env.get("TROLLCITY_SERVICE_KEY") || Deno.env.get("SUPABASE_SERVICE_ROLE_KEY")!;
