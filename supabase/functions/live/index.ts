          ...
          if (profileData?.broadcast_notification_until) {
            ...
            if (notificationUntil > new Date()) {
              ...
              if (follows && follows.length > 0) {
                ...
                // Send VAPID push notification to all followers in a single call
                ...
                console.log(`[Live] Notifications sent to ${follows.length} followers via VAPID:`, result);
              }
            }
