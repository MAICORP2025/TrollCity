  ...
  try {
    ...
    switch (action) {
      ...
      case 'join_battle_slot': {
       ...
       case 'update_battle_ready': {
         const { battle_id, hostReady, opponentReady } = body;
         const hostWillBeReady = hostReady ?? false;
         const opponentWillBeReady = opponentReady ?? false;
         
         const updateData: any = {};
         if (hostReady !== undefined) updateData.host_ready = hostWillBeReady;
         if (opponentReady !== undefined) updateData.opponent_ready = opponentWillBeReady;
