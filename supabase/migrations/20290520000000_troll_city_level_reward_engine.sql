-- Troll City Level + Achievement Engine
...
BEGIN
  ...
  IF v_rewards_granted > 0 THEN
    INSERT INTO public.user_achievement_events (
      ...
      'Your Troll City level rewards were added to your account.',
      v_current_level,
      v_reward_summary
    );
    ...
    INSERT INTO public.notifications (
      ...
      'level_reward',
      'You received level rewards!',
      'Your new Troll City level rewards were added to your account.',
      jsonb_build_object(
...
INSERT INTO public.level_rewards (
  ...
  (1000, 'badge', 'elite_troll_city_badge', 0, 'Elite Troll City Badge', 'Awarded at Level 1000', 'badge', 'elite_troll_city_badge'),
  ...
  (2000, 'badge', 'troll_city_legend_max_badge', 0, 'Troll City Legend Max Badge', 'Awarded at Level 2000', 'badge', 'troll_city_legend_max_badge'),
...
COMMENT ON TABLE public.level_rewards IS 'Catalog of level rewards and unlocks for Troll City level progression.';
