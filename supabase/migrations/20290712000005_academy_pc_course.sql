-- B2: Add a "PC Course for Troll City Academy" to the Academy catalog.
...
VALUES (
  ...
  'PC',
  'pc',
  'Personal computer literacy, skills, and safety for Troll City citizens.',
  '🖥️',
  '#06b6d4',
  7,
  true
...
SELECT '00000000-0000-0000-0000-00000000teach01', 'Troll City Academy', 'academy@trollcity.app', 'approved', 'Default Academy instructor'
...
SELECT
  ...
  'pc-course-for-troll-city-academy',
  'Learn the essentials of using a personal computer on Troll City: navigation, safety, accounts, and the tools every citizen needs to participate in the city.',
  'Personal computer literacy and skills for Troll City citizens.',
  'beginner',
  50,
  0,
  'free',
