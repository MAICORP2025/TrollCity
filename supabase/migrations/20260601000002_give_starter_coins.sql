...
-- Admin account trollcity2025@gmail.com is excluded
...
SET
  ...
  updated_at = now()
WHERE
  lower(COALESCE(email, '')) <> 'trollcity2025@gmail.com'
...
BEGIN
  ...
  v_role := CASE WHEN lower(v_email) = 'trollcity2025@gmail.com' THEN 'admin' ELSE 'user' END;
