...
VALUES
  ...
  ('handbook_acknowledgement', 'Employee Handbook Acknowledgement', 'policy',
   'Signed acknowledgement of the Troll City Employee Handbook and policies.', true, NULL, ARRAY['policy'], 80),
  ...
  ('tc_enrollment', 'Troll City Enrollment & E-Verify Consent', 'legal',
