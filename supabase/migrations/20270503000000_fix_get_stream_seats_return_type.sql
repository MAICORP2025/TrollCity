-- Migration: Fix get_stream_seats return type
-- Description: Updates troll_coins return type to BIGINT to match user_profiles table definition.
...
RETURNS TABLE (
    ...
    is_gold BOOLEAN,
    role TEXT,
    troll_coins BIGINT, -- Changed from INTEGER to BIGINT
