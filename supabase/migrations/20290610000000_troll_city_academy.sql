-- ============================================================
-- TROLL CITY ACADEMY - COMPLETE DATABASE SCHEMA
-- ============================================================
...
COMMENT ON TABLE public.academy_categories IS 'Course categories for Troll City Academy (Trades, Healthcare, Business, Technology, Life Skills, Refreshers)';
...
COMMENT ON TABLE public.academy_teachers IS 'Teacher profiles for Troll City Academy';
...
COMMENT ON TABLE public.academy_teacher_applications IS 'Teacher applications for Troll City Academy';
...
COMMENT ON TABLE public.academy_courses IS 'Courses offered by Troll City Academy';
