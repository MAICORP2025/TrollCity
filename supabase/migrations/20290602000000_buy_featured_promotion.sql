...
begin
  ...
  if p_feature_type = 'broadcast' then
    ...
    values (
      ...
      format('🔥 Featured Broadcast is now live in Troll City! A broadcaster just boosted their stream until %s', to_char(v_active_until, 'Mon DD, YYYY HH12:MI AM')),
      jsonb_build_object(
        'system_generated', true,
        'source', 'Troll City System',
