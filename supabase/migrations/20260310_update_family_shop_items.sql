-- Migration to update family_shop_items with the new catalog (40 items)
-- Replaces all previous shop items with the user-defined list
...
-- FAMILY BOOSTS (Spotlight / Placement)
...
('Extra Officer Slot (+1)', 'Adds 1 additional officer slot', 6900, 0, 'perk', false, true, false),
('Extra Officer Slots (+3)', 'Adds 3 additional officer slots', 19500, 0, 'perk', false, true, false),
('Family Shoutout System (3/day)', 'Family announcements show on family wall', 24500, 0, 'perk', false, true, false),
('Pinned Announcements Upgrade (2 pins)', 'Pin up to 2 announcements', 13800, 0, 'perk', false, true, false),
('Family Role Titles Pack', 'Unlock titles: Captain, Enforcer, General, Elder, etc.', 9200, 0, 'perk', false, true, false),

-- EMOTES / SOCIAL PACKS
('Family Emotes Pack #1', 'Basic family emotes pack', 2700, 0, 'perk', false, true, false),
('Family Emotes Pack #2 (Epic)', 'Epic family emotes pack', 11700, 0, 'perk', false, true, false),

-- FAMILY FEATURES / ENGAGEMENT SYSTEMS
('Family Voice Room Unlock (Coming Soon)', 'Unlocks family voice room feature', 18000, 0, 'perk', false, true, false),
('Family Poll System Unlock', 'Unlocks polling system for family', 6500, 0, 'perk', false, true, false),
('Family Event Scheduler Unlock', 'Unlocks event scheduler', 14800, 0, 'perk', false, true, false),
...
('Family XP Booster (24 Hours)', '+15% family XP for 24 hours', 4400, 0, 'boost', true, true, false),

-- LEGENDARY FAMILY EFFECTS
('Crown Aura (Legendary Family Effect)', 'Legendary Crown Aura effect', 60000, 0, 'prestige', false, true, false),
('Family Hall Entrance Animation', 'Special entrance animation for family hall', 28000, 0, 'prestige', false, true, false),
('Family Name Glow (Legendary)', 'Legendary glow effect for family name', 42000, 0, 'prestige', false, true, false);
