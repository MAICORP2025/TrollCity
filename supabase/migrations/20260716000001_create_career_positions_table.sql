...
VALUES
  ...
  ('prosecutor', 'Prosecutor', 'Troll Court', 'Represents Troll City in court cases, reviews evidence, presents charges, and supports city justice.', 10, true),
  ...
  ('journalist', 'Journalist', 'TCNN', 'Write articles, conduct investigations, and keep the city informed through Troll City News Network.', 10, true),
  ...
  ('agency_hr_manager', 'Agency HR Manager', 'Agency HR', 'Manage, approve, review, and settle issues for Troll City agencies.', 10, true),
  ('agency_hr', 'Agency HR', 'Agency HR', 'Support agency applications, reports, fee reviews, and HR operations.', 10, true),
  ('agency_leader', 'Agency Leader', 'Agencies', 'Lead a Troll City agency, recruit members, and grow creator talent.', 10, true),
