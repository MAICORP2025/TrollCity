-- Universal Earnings System for Troll City Stats Page
...
VALUES
    ('user', 'User', 'normal_activity_rewards', 0, 0, null, 'Default role for all Troll City users', null, true),
    ...
    ('president', 'President', 'treasury_weekly_payout', 5000, 0, 'treasury', 'Elected President of Troll City', null, true),
