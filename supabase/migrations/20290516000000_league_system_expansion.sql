-- Expanded Troll City League System
-- Adds long-term league progression, mission generation, and real leaderboard snapshots.

-- 1. Upgrade existing league_events schema to support system-generated Troll City events
...
SELECT '✅ Expanded Troll City league system installed' AS status;
