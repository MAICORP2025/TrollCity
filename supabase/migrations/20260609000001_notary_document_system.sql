-- Troll City Notary & Document Management System (NDS)
...
INSERT INTO public.document_types (slug, name, description, category, sort_order) VALUES
  ...
  ('loan_agreement', 'Loan Agreement', 'Troll City bank loan contract and terms', 'financial', 2),
  ...
  ('staff_application', 'Staff Application', 'Application to join Troll City staff', 'hr', 5),
...
-- ============================================================
-- DOCUMENT STAMPS (official Troll City approval stamps)
-- ============================================================
CREATE TABLE IF NOT EXISTS public.document_stamps (
  ...
  seal_text TEXT NOT NULL DEFAULT 'TROLL CITY OFFICIAL',
  approver_id UUID NOT NULL REFERENCES public.user_profiles(id),
  approver_username TEXT NOT NULL,
  approver_role TEXT NOT NULL,
...
BEGIN
  ...
  INSERT INTO public.document_stamps (
    ...
    p_document_id, v_approval_id, v_stamp_id, 'TROLL CITY OFFICIAL',
