-- Update cleanup function to use 10 second buffer and cover all inventory tables
...
BEGIN
  ...
  -- 4. Also clean up user_purchases if it exists (for backward compatibility or if used)
