...
export default function LandingPage() {
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // ALL HOOKS FIRST: Must be called unconditionally at the top
  // ═══════════════════════════════════════════════════════════════════════════
  ...
  return (
    <>
      ...
      {isLoading && (
        <div className="fixed inset-0 flex items-center justify-center bg-[#0A0814] z-50">
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="text-center lg:text-left space-y-8 animate-fade-in-up">
                  ...
                  <div className="space-y-4">
                    ...
                    {!user && (
                      <div className="max-w-xl mx-auto lg:mx-0 rounded-2xl border border-emerald-400/30 bg-emerald-500/10 px-4 py-3 text-sm text-emerald-100">
                        New user launch promo starts May 1, 2026 at 3:00 PM MDT: earn a 1,000 coin bonus on your first 5,000 coin cashout.
                      </div>
                    )}
                  </div>
