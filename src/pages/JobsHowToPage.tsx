...
const jobPositions: JobPosition[] = [
  ...
  },
  {
    ...
    description:
      'Manage, approve, review, and settle issues for Troll City agencies. Salaried HR management employee.',
...
async function generateI9Section2Pdf(data: I9Section2Data): Promise<Uint8Array> {
  ...
  line('TROLL CITY', { size: 16, font: bold, color: [0.05, 0.6, 0.72] })
  ...
  rule()
  page.drawText(
    `Generated by Troll City HR · ${new Date().toISOString().slice(0, 10)} · This is an internal I-9 Section 2 record.`,
...
export default function JobsHowToPage() {
  ...
  useSEO({
    title: 'Careers | Troll City - Employee Positions & Platform Roles',
    description:
      'Apply for payroll employee positions and community platform roles at Troll City. Track your applications, view status, and join the team.',
    keywords: ['careers', 'jobs', 'hiring', 'troll city jobs', 'employee positions', 'platform roles'],
  })
