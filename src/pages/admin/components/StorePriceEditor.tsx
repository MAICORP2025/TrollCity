...
const initialCatalogs: Record<TableKey, any[]> = {
 ...
 const fallbackCatalogs: Record<TableKey, any[]> = {
   coin_packages: [
     { id: 'pkg-100', name: 'Micro Pack', coins: 100, currency: 'USD', price: 1.00, description: 'Basic coin pack' },
     { id: 'pkg-300', name: 'Baby Troll', coins: 300, currency: 'USD', price: 3.00, description: 'Starter pack' },
     { id: 'pkg-500', name: 'Little Troller', coins: 500, currency: 'USD', price: 5.00, description: 'Great for casual' },
     { id: 'pkg-1000', name: 'Mischief Troll', coins: 1000, currency: 'USD', price: 10.00, description: 'Medium bundle' },
     { id: 'pkg-2500', name: 'Empire Troll', coins: 2500, currency: 'USD', price: 25.00, description: 'Top-tier bundle' },
   ],
  entrance_effects: [
