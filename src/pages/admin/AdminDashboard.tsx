...
export default function AdminDashboard() {
  ...
  // Map finance summary to stats for backward compatibility
  const stats: StatState = financeSummary ? {
    totalUsers: financeSummary.users.totalUsers,
    adminsCount: financeSummary.users.adminsCount,
    pendingApps: financeSummary.users.pendingApps,
    pendingPayouts: financeSummary.users.pendingPayouts,
    trollOfficers: financeSummary.users.trollOfficers,
    aiFlags: financeSummary.users.aiFlags,
    coinSalesRevenue: financeSummary.economy.coinSalesRevenue,
    totalPayouts: financeSummary.economy.totalPayouts,
    feesCollected: financeSummary.economy.feesCollected,
    platformProfit: financeSummary.economy.platformProfit,
    purchasedCoins: financeSummary.economy.purchasedCoins,
    earnedCoins: financeSummary.economy.earnedCoins,
    freeCoins: financeSummary.economy.freeCoins,
    totalCoinsInCirculation: financeSummary.economy.totalCoinsInCirculation,
  ...
  useEffect(() => {
    ...
    // Polling for non-finance data (every 30s)
  ...
  }, [isAuthorized, loadLiveStreams, loadTaskCounts])
