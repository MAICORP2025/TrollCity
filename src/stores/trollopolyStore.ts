...
const TROLLOPOLY_PROPERTIES: TrollopolyProperty[] = [
  { id: 1, name: 'Troll Plaza', type: 'city', price: 60, rent: 2, ownerId: null, buildingLevel: 0, group: 'brown' },
  { id: 2, name: 'Troll Park', type: 'city', price: 60, rent: 4, ownerId: null, buildingLevel: 0, group: 'brown' },
  { id: 3, name: 'Troll Café', type: 'city', price: 100, rent: 6, ownerId: null, buildingLevel: 0, group: 'lightBlue' },
  { id: 4, name: 'Troll Mall', type: 'city', price: 100, rent: 6, ownerId: null, buildingLevel: 0, group: 'lightBlue' },
  { id: 5, name: 'Troll Arcade', type: 'city', price: 120, rent: 8, ownerId: null, buildingLevel: 0, group: 'lightBlue' },
  { id: 6, name: 'Troll Taxi', type: 'transport', price: 150, rent: 25, ownerId: null, buildingLevel: 0, group: 'transport' },
  { id: 7, name: 'Troll Diner', type: 'city', price: 140, rent: 10, ownerId: null, buildingLevel: 0, group: 'pink' },
  { id: 8, name: 'Troll Gym', type: 'city', price: 140, rent: 10, ownerId: null, buildingLevel: 0, group: 'pink' },
  { id: 9, name: 'Troll Spa', type: 'city', price: 160, rent: 12, ownerId: null, buildingLevel: 0, group: 'pink' },
  { id: 10, name: 'Troll Bank', type: 'utility', price: 150, rent: 4, ownerId: null, buildingLevel: 0, group: 'utility' },
  { id: 11, name: 'Troll Hotel', type: 'city', price: 180, rent: 14, ownerId: null, buildingLevel: 0, group: 'orange' },
  { id: 12, name: 'Troll Cinema', type: 'city', price: 180, rent: 14, ownerId: null, buildingLevel: 0, group: 'orange' },
  { id: 13, name: 'Troll Stadium', type: 'city', price: 200, rent: 16, ownerId: null, buildingLevel: 0, group: 'orange' },
  { id: 14, name: 'Troll Power', type: 'utility', price: 150, rent: 4, ownerId: null, buildingLevel: 0, group: 'utility' },
  { id: 15, name: 'Troll Tower', type: 'city', price: 220, rent: 18, ownerId: null, buildingLevel: 0, group: 'red' },
  { id: 16, name: 'Troll HQ', type: 'city', price: 240, rent: 20, ownerId: null, buildingLevel: 0, group: 'red' },
  { id: 17, name: 'Troll Labs', type: 'city', price: 260, rent: 22, ownerId: null, buildingLevel: 0, group: 'red' },
  { id: 18, name: 'Troll Transit', type: 'transport', price: 200, rent: 25, ownerId: null, buildingLevel: 0, group: 'transport' },
  { id: 19, name: 'Troll Beach', type: 'city', price: 300, rent: 26, ownerId: null, buildingLevel: 0, group: 'green' },
  { id: 20, name: 'Troll Resort', type: 'city', price: 320, rent: 28, ownerId: null, buildingLevel: 0, group: 'green' },
  { id: 21, name: 'Troll Island', type: 'city', price: 350, rent: 35, ownerId: null, buildingLevel: 0, group: 'green' },
  { id: 22, name: 'Troll Port', type: 'transport', price: 200, rent: 25, ownerId: null, buildingLevel: 0, group: 'transport' },
  { id: 23, name: 'Free Parking', type: 'event', price: 0, rent: 0, ownerId: null, buildingLevel: 0, group: 'special' },
  { id: 24, name: 'Jail', type: 'event', price: 0, rent: 0, ownerId: null, buildingLevel: 0, group: 'special' },
  { id: 25, name: 'Go to Jail', type: 'event', price: 0, rent: 0, ownerId: null, buildingLevel: 0, group: 'special' },
];
...
export interface TrollopolyMatch {
  id: string;
  streamId: string;
  status: 'lobby' | 'piece_selection' | 'playing' | 'finished';
...
export const useTrollopolyStore = create<TrollopolyStore>((set, get) => ({
  ...
  createMatch: (streamId, hostId, hostUsername) => {
    ...
    const hasEnoughPlayers = [hostPlayer].length >= DEFAULT_TROLLOPOLY_CONFIG.minPlayers;

    const match: TrollopolyMatch = {
      id: `trollopoly-${streamId}-${Date.now()}`,
      streamId,
      status: 'lobby',
      phase: hasEnoughPlayers ? 'piece_selection' : 'lobby',
      players: [hostPlayer],
      currentTurnIndex: 0,
  ...
  addPlayer: (player) => {
    ...
    const shouldStartCountdown = newPlayers.length >= config.minPlayers && match.countdownRemaining === config.joinCountdown;

    set({
      match: {
        ...match,
        players: newPlayers,
        countdownRemaining: shouldStartCountdown ? config.joinCountdown : match.countdownRemaining,
      }
    });
  },
