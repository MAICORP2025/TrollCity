...
import TutorialProvider from "./components/TutorialWalkthrough";
import TutorialPagePopup from "./components/TutorialPagePopup";
...
const HomeRedirect = () => {
  ...
  const { userId, profile, profileRole } = useAuthStore();
  ...
  }, [userId, profile, profileRole, navigate]);
...
const BroadcastMobilePreviewPage = lazyWithRetry(() => import("./pages/dev/BroadcastMobilePreviewPage"));
const LiveAuctionPreview = lazyWithRetry(() => import("./pages/dev/LiveAuctionPreview"));
const BroadcastLayoutSelector = lazyWithRetry(() => import("./pages/dev/BroadcastLayoutSelector"));
const TutorialPreview = lazyWithRetry(() => import("./pages/dev/TutorialPreview"));
const ScreenshotCapture = lazyWithRetry(() => import("./pages/dev/ScreenshotCapture"));
...
const BrokerApplication = lazyWithRetry(() => import("./pages/BrokerApplication"));
...
function AppContent() {
  ...
  }, [user?.id, profile, navigate, supabase, location.pathname]);
...
<Route path="/district/:districtName" element={<DistrictTour />} />
                  ...
                  <Route path="/dev/homepage-bg-showcase" element={<HomepageBackgroundShowcase />} />
                   ...
                   <Route path="/dev/easter-theme-preview" element={<EasterThemePreview />} />
                    ...
                    <Route path="/dev/broadcast-mobile-preview" element={<BroadcastMobilePreviewPage />} />
                   <Route path="/dev/live-auction-preview" element={<LiveAuctionPreview />} />
                    <Route path="/dev/tutorial-preview" element={<TutorialPreview />} />
                    <Route path="/dev/screenshots" element={<ScreenshotCapture />} />
