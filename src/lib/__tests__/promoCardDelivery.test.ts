...
jest.mock('../../services/utromailService', () => ({
  ...
  UTROMAIL_SYSTEM_SENDER_MAIL: 'system@tromail.trollcity',
}))
...
describe('sendPromoCardMailToUser', () => {
  ...
  it('delivers promo cards as a Troll City System message that can reuse the same thread', async () => {
    ...
    expect(sendMessage).toHaveBeenCalledWith(expect.objectContaining({
      ...
      senderMail: 'system@tromail.trollcity',
      recipientId: 'user-1',
