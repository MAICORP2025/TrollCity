...
export interface SupabaseUsageSnapshot {
  ...
  databaseGbHours?: number | null
  databaseCpuHours?: number | null
  storageGb?: number | null
  storageEgressGb?: number | null
  storageBucketGb?: number | null
  authMonthlyActiveUsers?: number | null
  realtimeChannels?: number | null
...
export function calculateSupabaseMonthlyEstimate(snapshot: SupabaseUsageSnapshot): SupabaseCostEstimate {
