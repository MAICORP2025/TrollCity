...
// Single source of truth for coin valuation (100 coins = $1)
export const STORE_USD_PER_COIN = 0.01;

// Coin Packages (Source of Truth) - 100 coins = $1
export const COIN_PACKAGES = [
  { id: 'pkg-100', coins: 100, price: 1.00, priceDisplay: "$1.00", emoji: "🟢", name: "Micro" },
...
export const cashoutTiers = [
  { id: "tier1", name: "Tier 1", coins: 5000, payout: 25 },
