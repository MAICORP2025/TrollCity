...
const TIER_TASK_TEMPLATES: Record<number, Array<Omit<LeagueTask, 'current' | 'status' | 'cycleKey'>>> = {
  0: [
    ...
    { id: 't0-streak', tier: 0, tierLabel: 'T0', week: 4, title: 'Log in 3 days this week', description: 'Open Troll City on 3 different days this week.', target: 3, rewardXp: 150, rewardCoins: 10, progressSource: P.streak },
  ...
  1: [
    ...
    { id: 't1-daily', tier: 1, tierLabel: 'T1', week: 1, title: 'Complete 1 daily mission', description: 'Finish any daily mission offered by Troll City.', target: 1, rewardXp: 200, rewardCoins: 10, progressSource: P.streak },
    ...
    { id: 't1-streak', tier: 1, tierLabel: 'T1', week: 4, title: 'Log in 4 days this week', description: 'Open Troll City on 4 different days this week.', target: 4, rewardXp: 300, rewardCoins: 10, progressSource: P.streak },
  ...
  2: [
    ...
    { id: 't2-streak', tier: 2, tierLabel: 'T2', week: 4, title: 'Log in 4 days this week', description: 'Open Troll City on 4 different days this week.', target: 4, rewardXp: 500, rewardCoins: 10, progressSource: P.streak },
  ...
  3: [
    ...
    { id: 't3-streak', tier: 3, tierLabel: 'T3', week: 4, title: 'Log in 5 days this week', description: 'Open Troll City on 5 different days this week.', target: 5, rewardXp: 800, rewardCoins: 10, progressSource: P.streak },
  ...
  4: [
    ...
    { id: 't4-streak', tier: 4, tierLabel: 'T4', week: 4, title: 'Log in 5 days this week', description: 'Open Troll City on 5 different days this week.', target: 5, rewardXp: 1200, rewardCoins: 10, progressSource: P.streak },
  ...
  5: [
    ...
    { id: 't5-streak', tier: 5, tierLabel: 'T5', week: 4, title: 'Log in 5 days this week', description: 'Open Troll City on 5 different days this week.', target: 5, rewardXp: 2000, rewardCoins: 10, progressSource: P.streak },
  ...
  6: [
    ...
    { id: 't6-streak', tier: 6, tierLabel: 'T6', week: 4, title: 'Log in 6 days this week', description: 'Open Troll City on 6 different days this week.', target: 6, rewardXp: 4000, rewardCoins: 10, progressSource: P.streak },
  ...
  7: [
    ...
    { id: 't7-streak', tier: 7, tierLabel: 'T7', week: 4, title: 'Log in 6 days this week', description: 'Open Troll City on 6 different days this week.', target: 6, rewardXp: 7000, rewardCoins: 10, progressSource: P.streak },
  ...
  8: [
    ...
    { id: 't8-streak', tier: 8, tierLabel: 'T8', week: 4, title: 'Log in 7 days this week', description: 'Open Troll City every day this week.', target: 7, rewardXp: 16000, rewardCoins: 10, progressSource: P.streak },
  ...
  9: [
    ...
    { id: 't9-xp', tier: 9, tierLabel: 'T9', week: 1, title: 'Earn 50,000 XP', description: 'Stack 50,000 XP of honest Troll City activity.', target: 50000, rewardXp: 60000, rewardCoins: 10, progressSource: P.xp },
    ...
    { id: 't9-xp-2', tier: 9, tierLabel: 'T9', week: 3, title: 'Earn 75,000 XP', description: 'Stack 75,000 XP of honest Troll City activity.', target: 75000, rewardXp: 80000, rewardCoins: 10, progressSource: P.xp },
    ...
    { id: 't9-streak', tier: 9, tierLabel: 'T9', week: 4, title: 'Log in 7 days this week', description: 'Open Troll City every day this week.', target: 7, rewardXp: 50000, rewardCoins: 10, progressSource: P.streak },
    ...
    { id: 't9-xp-3', tier: 9, tierLabel: 'T9', week: 4, title: 'Earn 100,000 XP', description: 'Stack 100,000 XP of honest Troll City activity.', target: 100000, rewardXp: 100000, rewardCoins: 10, progressSource: P.xp },
  ],
  10: [
    ...
    { id: 't10-xp', tier: 10, tierLabel: 'T10', week: 3, title: 'Earn 150,000 XP', description: 'Stack 150,000 XP of honest Troll City activity.', target: 150000, rewardXp: 140000, rewardCoins: 10, progressSource: P.xp },
    ...
    { id: 't10-streak', tier: 10, tierLabel: 'T10', week: 4, title: 'Log in 7 days this week', description: 'Open Troll City every day this week.', target: 7, rewardXp: 100000, rewardCoins: 10, progressSource: P.streak },
