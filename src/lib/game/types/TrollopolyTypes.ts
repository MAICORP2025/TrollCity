...
export interface TrollopolyGameState extends BaseGameState {
  ...
  gameBalance: number; // Total coins in the game pot
  turnCount: number;
  startTime: number;
}
...
export const TROLLOPOLY_PROPERTIES: Omit<Property, 'ownerId' | 'houseCount' | 'hasHotel' | 'isMortgaged'>[] = [
  ...
  { id: 30, name: 'Jail Transport', type: 'special', price: 0, baseRent: 0, houseCost: 0, hotelCost: 0, rents: [], color: '#333333', position: { x: 8, z: -3 }, rotation: Math.PI },
