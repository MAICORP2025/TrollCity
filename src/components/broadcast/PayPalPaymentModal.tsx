...
export default function PayPalPaymentModal({
  ...
  const loadPayPalSDK = async () => {
    ...
    script.src = `https://www.paypal.com/sdk/js?client-id=${import.meta.env.VITE_PAYPAL_CLIENT_ID || 'AVfWkihJviS8yW8MaoUzG0J6I8zaChoqEUj0QCfflIKGwBXV-iGQO3ncVNsAvZR36L00BQpGc1Z0WbrF'}&currency=USD&intent=capture`;
        ...
        {step === 'select' && (
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-4">
              ...
              <div ref={paypalButtonsRef} className="paypal-buttons-container"></div>
            </div>
