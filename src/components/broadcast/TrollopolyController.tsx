...
export default function TrollopolyController({
  ...
  const isLobby = match.phase === 'lobby' || match.phase === 'piece_selection';
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="flex items-center justify-between">
         ...
         <div className="flex items-center justify-between">
           ...
           <span className="text-sm font-bold text-white">{match.players.length}/4</span>
         </div>
        ...
        <div className="pt-2 border-t border-white/10 space-y-2">
          {isLobby && match.players.length >= 1 && (
            <button
              onClick={onStartGame}
