...
export default function BroadcastControls({
  ...
  const isCEO = profile?.username === 'ceo' || profile?.role === 'ceo';
  ...
  return (
    <>
      ...
      <div className="flex items-center gap-3">
        ...
        {/* Universe Battle (Battle category only, when live) */}
        {onFiveVFiveBattle && isHost && isLive && !fiveVFiveBattleActive && categoryConfig.id === 'battle' && (
          <OrbBtn
            active={false}
            onClick={async () => {
