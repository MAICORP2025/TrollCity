...
import { Shield, AlertTriangle, UserX, Lock, Ban } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      {!canEnforce ? (
        <div className="text-center py-12 text-slate-500">
          ...
          <p>Only officers and above can access jail tools.</p>
        </div>
      ) : (
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-xl p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="font-bold">Permanent Ban</h3>
                <p className="text-sm text-slate-400">Permanent account removal</p>
              </div>
            </div>
            <button className="w-full py-2 bg-slate-800 hover:bg-slate-700 rounded-lg font-medium transition-colors">
              Issue Permanent Ban
