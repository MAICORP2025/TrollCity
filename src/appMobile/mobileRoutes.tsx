...
export const mobileRoutes: MobileRouteItem[] = [
  ...
  },
  {
    ...
    label: "Secretary",
    path: "/secretary",
    element: <MobilePlaceholder title="Secretary Dashboard" />,
    icon: Briefcase,
    priority: 130,
  ...
  },
  {
    ...
    label: "President",
    path: "/president",
    element: <MobilePlaceholder title="President Dashboard" />,
    icon: Crown,
    priority: 140,
  ...
  },
  {
    ...
    label: "Pastor",
    path: "/pastor",
    element: <MobilePlaceholder title="Pastor Dashboard" />,
    icon: Users,
    priority: 150,
  ...
  },
  {
    ...
    label: "Prosecutor",
    path: "/prosecutor",
    element: <MobilePlaceholder title="Prosecutor Dashboard" />,
    icon: Scale,
    priority: 170,
  ...
  },
  {
    ...
    label: "Attorney",
    path: "/attorney",
    element: <MobilePlaceholder title="Attorney Dashboard" />,
    icon: FileText,
    priority: 180,
  ...
  },
  {
    ...
    label: "TCNN",
    path: "/tcnn",
    element: <MobilePlaceholder title="TCNN" />,
    icon: Radio,
    priority: 200,
