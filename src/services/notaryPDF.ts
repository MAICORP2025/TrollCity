...
export function generateStampSVG(stamp: StampData): string {
  ...
  <text x="140" y="52" text-anchor="middle" fill="#93c5fd" font-family="monospace" font-size="9">APPROVED BY TROLL CITY</text>
...
<div style="text-align:center;margin-bottom:30px;padding-bottom:20px;border-bottom:2px solid #1e3a5f;">
  <div style="font-family:monospace;font-size:24px;font-weight:bold;color:#3b82f6;letter-spacing:2px;">TROLL CITY</div>
...
<div style="margin-top:40px;padding-top:16px;border-top:1px solid #1e293b;text-align:center;">
  <div style="font-family:monospace;font-size:8px;color:#475569;">Generated by Troll City Notary & Document Management System. ${stamp ? `Verify at trollcity.app/verify/${stamp.verification_code}` : 'Verification pending.'}</div>
