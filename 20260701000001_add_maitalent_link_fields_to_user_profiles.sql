...
COMMENT ON COLUMN public.user_profiles.maitalent_link_status IS 'Current MaiTalent linkage status for the Troll City profile';
...
COMMENT ON COLUMN public.user_profiles.maitalent_external_user_id IS 'Troll City user identifier associated with the MaiTalent link';
