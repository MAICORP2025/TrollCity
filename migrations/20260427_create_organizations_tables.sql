...
-- Create organization_admins table for multi-admin support
...
-- Create organization_students table for tracking student membership
...
-- Triggers to keep student count updated
